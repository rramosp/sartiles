...
def main():
    ...
    grid_parser.add_argument('--start_date', required=True, type=str, help='start date for ASF query')
    grid_parser.add_argument('--end_date', required=True, type=str, help='end_date for ASF query')
    grid_parser.add_argument('--mode', default='most-frequent', type=str, help='month to query')
